...
namespace Com.MM.Service.Core.Test.Controllers.CategoryTests
{
    [Collection("TestFixture Collection")]
    public class BasicTest : BasicControllerTestOldVM<CoreDbContext, ArticleCategoryService, ArticleCategory, ArticleCategoryViewModel, CategoryDataUtil>
    {
